...
<div style="display: flex; justify-content: center; align-items: center; width: 100%;">
    <div style="width: 1200px; height: 600px; display: flex; flex-direction: column; position: relative; overflow: hidden;">
        ...
        <svg style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 2;">
            ...
            <text x="336" y="270" font-family="Arial" font-size="20" fill="blue" text-anchor="middle" font-weight="bold">대기반사</text>
            <text x="336" y="295" font-family="Arial" font-size="20" fill="blue" text-anchor="middle" font-weight="bold">25</text>
